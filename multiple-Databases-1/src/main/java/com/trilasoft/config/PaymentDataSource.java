...
@Configuration
@EnableJpaRepositories(basePackages = "com.trilasoft.repository.payment", 
...
public class PaymentDataSource {
	...
	LocalContainerEntityManagerFactoryBean paymentEntityManagerFactory(EntityManagerFactoryBuilder builder) {
		return builder.dataSource(getDataSource()).packages("com.trilasoft.entity.payment").build();
	}
